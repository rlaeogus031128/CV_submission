...
from models.lightweightOB.lightwegiht_models import yoloTrain



def submission_3_20226275(yaml_path, output_json_path):
    ...
    ex_dict = yoloTrain.train_model(ex_dict)
